        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-300">
                  Your personal career guide and mentor
                </p>
              </div>
          ...
          >
            {messages.map((message, index) => (
              ...
              >
                <div
                  className={`max-w-[80%] p-4 rounded-xl shadow-lg break-words ${
                    message.role === "user"
          ...
          <form
            ...
            className="p-4 bg-gray-800/50 border-t border-gray-700/50 rounded-b-2xl"
          >
